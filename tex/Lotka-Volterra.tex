...
\subsection{Trajektorija sistema}
...
\begin{displaymath}
    ...
    \end{aligned}
\end{displaymath}
čija rešenja predstavljaju putanje sistema za različite parametre
$a$, $b$, $c$, $m$ i konstantu $C$.
...
\subsection{Stacionarno rešenje za model sa logističkom modifikacijom}
\begin{figure}[H]
    \centering
